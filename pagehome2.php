...
<html lang="en">
  ...
  <body>
    <header class="hero-section">
        <img src="Assets/white logo.png" alt="La Prima Logo" class="hero-logo" style="position: sticky; margin: 80px;"> 
       <?php
       require 'navbar.php';
       ?>
    </header>
    ...
    <section class="welcome-section">
        <h1>WELCOME TO LA PRIMA HAUTE COUTURE,
        </h1>
        <section id="home"> 
                <p>
        ...
        <p>Crafting dreams into reality with every stitch.</p>
        <a href="page1Design.php">
        <button class="btn">Start Design Your Dresses </button>
        </a>
    </section>
